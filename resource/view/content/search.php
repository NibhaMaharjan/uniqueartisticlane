...
<main class="main">
	<div class="banner banner-cat" style="background-image: url('public/assets/images/mandala.png');">
		<div class="banner-content container">
			<h2 class="banner-subtitle text-dark"><span>check out our collection <?= date("Y"); ?></span></h2>
					...
					<?php 
						...
						if(empty($searchedProductList))
						{
							echo '<div class="d-flex justify-content-center">
										<img src="public/assets/images/mysorry.png" style="width: auto; height:400px;"/>
									</div>';
						}
					?>
									...
									<div class="col-6 col-md-4 col-xl-3">
										<div class="grid-product">
											...
											<div class="product-details">
												...
												<div class="price-box">
													<span class="product-price">Rs '. $eachProduct['product_price'] .'</span>
												</div>
