						...
						<div class="row">
							<div class="col-md-3 col-xs-2">
								<div class="invoice-title">
									<h1>invoice</h1>
									<img class="logo-print" src="public\assets\images\favicon\mylogo.png" alt="" style="width: 220px; height: 60px;">
								</div>
							</div>
					...
					<div class="row invoice-to">
						<div class="col-md-9 col-sm-4 pull-left">
							...
							<?php
								...
								<p>'. @$shippingDetails[0]['shipcstmr_profession'] .'<br>'.'+977' .
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-8 col-xs-7 payment-method">
								<p style="font-style: normal; font-size: 17px;" class="inv-label mt-1 mb-2"> 
									<span style="color: orange; font-weight: bold;">IN AMOUNT: </span>
									<?php echo $getAmount->inAwords($getdetailsResult[0]['grand_total']) . ' Rupees ONLY'; ?>
								</p>
								<h3 class="inv-label itatic">Thank you for your business</h3>
							</div>
							<div class="col-md-4 col-xs-5 invoice-block pull-right">
