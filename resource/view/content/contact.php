			...
			<script type="text/javascript">
				...
				function init() {
					...
					var marker = new google.maps.Marker({
						map: map,
						position: new google.maps.LatLng(27.714495869805088, 85.31211861534354)
					});
					infowindow = new google.maps.InfoWindow({
						content: "<b>Unique Artistic Lane</b><br/>Tridevi Sadak, Thamel"
					});
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					<div>
						...
						<p><a href="tel:">+977 9841293336</a></p>
						<p>Cell Number</p>
					</div>
					<div>
						<i class="icon-mail-alt"></i>
						<p><a href="mailto:#">bhairajamaharjan@gmail.com</a></p>
					</div>
