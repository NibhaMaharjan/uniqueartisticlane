							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>Tridevi Sadak, Thamel, Kathmandu</li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:bhairajamaharjan6@gmail.com">bhairajamaharjan6@gmail.com</a></li>
										<li><span class="contact-info-label">Working Days/Hours:</span>Mon - Sun / 10:00AM - 8:00PM</li>
									</ul>
								</div>
							</div>
						</div>
