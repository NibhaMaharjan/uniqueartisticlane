...
<html lang="en">
	<head>
		...
		<meta name="author" content="Nibha Maharjan">
		<title>Unique Artistic Lane | <?php echo $pageTitle ?> </title>
		
		<link rel="icon" type="image/icon" href="public/assets/images/favicon/logo1.png">
	...
	<body>
		...
		<div class="page-wrapper">
			<header class="header" id="header">
				...
				<div class="header-middle" style="background-color: #e4e2dd;">
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 100px;" src="public\assets\images\favicon\mylogo.png" alt="Unique Artistic Lane">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+977 9841293336</strong></a>
							</div>
