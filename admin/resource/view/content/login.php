...
<html lang="en">
	<head>
		...
		<title>AdminLogin|UniqueArtisticLane</title>
		
		<!--=*= CSS FILES SOURCE START =*=-->
		<link rel="shortcut icon" href="../public/assets/images/favicon/logo1.png" type="image/png">
		...
		<div class="container">
			<form class="form-signin" method="post" action="">
				<div class="form-signin-heading text-center">
					...
					<img class="disable" src="../public/assets/images/favicon/mylogo.png" alt="" style="width: 80%;"/>
				</div>
