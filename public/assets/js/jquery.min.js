...
!(function (e, t) {
							...
							return 1 === r && 0 === i
								...
								: function (t, n, u) {
										var l,
											...
											h,
											g =
												o !== a ? "nextSibling" : "previousSibling",
											y = t.parentNode,
					...
					pseudos: {
						...
						contains: se(function (e) {
							return (
								...
								function (t) {
									return (
										(t.textContent || t.innerText || i(t)).indexOf(
											e
										) > -1
									);
								}
		...
		ajax: function (t, n) {
			...
			function k(t, n, r, s) {
				...
				c ||
					...
					(x = void 0),
					f &&
						y.trigger(l ? "ajaxSuccess" : "ajaxError", [E, h, l ? p : d]),
					m.fireWith(g, [E, C]),
					f &&
	...
	w.ajaxSetup({
		...
		w.each(["top", "left"], function (e, t) {
			w.cssHooks[t] = _e(h.pixelPosition, function (e, n) {
				if (n)
					return (
						(n = Fe(e, t)), We.test(n) ? w(e).position()[t] + "px" : n
					);
			});
		}),
	...
	return (
		(w.noConflict = function (t) {
			return (
				e.$ === w && (e.$ = Kt), t && e.jQuery === w && (e.jQuery = Jt), w
			);
		}),
		t || (e.jQuery = e.$ = w),
		w
